...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_model_dir", type=str, default="data/output_random")
    ...
    if args.text_type == "SciBERT":
        ...
        text_model = AutoModel.from_pretrained('data/pretrained_SciBERT/models--allenai--scibert_scivocab_uncased').to(device)
